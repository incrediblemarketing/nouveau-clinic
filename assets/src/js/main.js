        ...
        var IM = {
            ...
            utils: {
                ...
                stickySiteNav: function() {
                    ...
                    if (header4.length > 0) {
                        $('body').addClass('h4-header');

                        $cache.window.scroll(function() {
                            if ($cache.window.scrollTop() >= header4.outerHeight()) {
                                $('.h4-header').addClass('scrolling');
                            } else {
                                $('.h4-header').removeClass('scrolling');
                            }
                        });
                    }
                },
